...
#define __ANALYSIS_ISOCONTOUR_3D__
...
analysis_frame_t * analysis_frame_ISOCONTOUR_3D_init(roi_t * roi, volume_t * volume, guint frame);

#endif /* __ANALYSIS_ISOCONTOUR_3D__ */
