...
GSList * roi_ELLIPSOID_get_intersection_line(const roi_t * roi, const volume_t * view_slice) {
...
volume_t * roi_ELLIPSOID_get_slice(const roi_t * roi, const volume_t * view_slice) {
...
void roi_ELLIPSOID_set_isocontour(roi_t * roi, volume_t * vol, voxelpoint_t iso_vp) {
  ...
  g_return_if_fail(roi->type == ELLIPSOID);
