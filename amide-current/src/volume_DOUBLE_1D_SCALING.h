...
#ifndef __VOLUME_DOUBLE_1D_SCALING__
#define __VOLUME_DOUBLE_1D_SCALING__
...
#define VOLUME_DOUBLE_1D_SCALING_CONTENTS(volume,i) \
...
#endif /* __VOLUME_DOUBLE_1D_SCALING__ */
