...
GSList * roi_CYLINDER_get_intersection_line(const roi_t * roi, const volume_t * view_slice);
#endif

#if defined(ROI_ISOCONTOUR_2D_TYPE) || defined(ROI_ISOCONTOUR_3D_TYPE)
volume_t * roi_CYLINDER_get_slice(const roi_t * roi, const volume_t * view_slice);
