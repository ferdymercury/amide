...
data_set_t * data_set_FLOAT_0D_SCALING_init(data_set_FLOAT_t init_value) {
  ...
  (*DATA_SET_FLOAT_0D_SCALING_POINTER(temp_data_set, i)) = init_value;
...
data_set_t * data_set_FLOAT_2D_init(data_set_FLOAT_t init_value, 
  ...
  data_set_FLOAT_initialize_data(temp_data_set, init_value);
...
void data_set_FLOAT_initialize_data(data_set_t * data_set, 
  ...
  for (i.t = 0; i.t < data_set->dim.t; i.t++)
	...
	for (i.x = 0; i.x < data_set->dim.x; i.x++) 
	  DATA_SET_FLOAT_SET_CONTENT(data_set,i)=0.0;
