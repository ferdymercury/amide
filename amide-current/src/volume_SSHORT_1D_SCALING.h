...
#ifndef __VOLUME_SSHORT_1D_SCALING__
#define __VOLUME_SSHORT_1D_SCALING__
...
#define VOLUME_SSHORT_1D_SCALING_CONTENTS(volume,i) \
 (*(DATA_SET_FLOAT_1D_SCALING_POINTER((volume)->current_scaling, (i))) * \
  ((amide_data_t) (*(DATA_SET_SSHORT_POINTER((volume)->data_set,(i))))))
...
#endif /* __VOLUME_SSHORT_1D_SCALING__ */
