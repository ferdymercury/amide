...
#ifndef __VOLUME_SSHORT_2D_SCALING__
#define __VOLUME_SSHORT_2D_SCALING__
...
#define VOLUME_SSHORT_2D_SCALING_CONTENTS(volume,i) \
...
#endif /* __VOLUME_SSHORT_2D_SCALING__ */
