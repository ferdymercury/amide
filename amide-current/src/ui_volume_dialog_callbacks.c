...
void ui_volume_dialog_callbacks_change_scan_date(GtkWidget * widget, gpointer data) {
  ...
  volume_set_name(volume_new_info, new_date);
  g_free(new_date);
...
void ui_volume_dialog_callbacks_apply(GtkWidget* widget, gint page_number, gpointer data) {
  ...
  /*  done in ui_threshold: ui_volume_list_item->volume->color_table = volume_new_info->color_table; */
