...
#ifndef __VOLUME_USHORT_2D_SCALING__
#define __VOLUME_USHORT_2D_SCALING__
...
#define VOLUME_USHORT_2D_SCALING_CONTENTS(volume,i) \
...
#endif /* __VOLUME_USHORT_2D_SCALING__ */
