...
GSList * roi_ISOCONTOUR_2D_get_slice_intersection(const roi_t * roi, const volume_t * view_slice);
#endif

#if defined(ROI_ISOCONTOUR_2D_TYPE) || defined(ROI_ISOCONTOUR_3D_TYPE)
roi_t * roi_ISOCONTOUR_2D_get_slice_intersection(const roi_t * roi, const volume_t * view_slice);
...
#undef ROI_ISOCONTOUR_2D_TYPE

#endif /* __ROI_ISOCONTOUR_2D__ */
