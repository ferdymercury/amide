...
#ifndef __VOLUME_DOUBLE_2D_SCALING__
#define __VOLUME_DOUBLE_2D_SCALING__
...
#define VOLUME_DOUBLE_2D_SCALING_CONTENTS(volume,i) \
 (*(DATA_SET_FLOAT_2D_SCALING_POINTER((volume)->current_scaling, (i))) * \
...
#endif /* __VOLUME_DOUBLE_2D_SCALING__ */
