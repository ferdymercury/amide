...
#ifndef __VOLUME_SINT_2D_SCALING__
#define __VOLUME_SINT_2D_SCALING__
...
#define VOLUME_SINT_2D_SCALING_CONTENTS(volume,i) \
 (*(DATA_SET_FLOAT_2D_SCALING_POINTER((volume)->current_scaling, (i))) * \
  ((amide_data_t) (*(DATA_SET_SINT_POINTER((volume)->data_set,(i))))))
...
#endif /* __VOLUME_SINT_2D_SCALING__ */
