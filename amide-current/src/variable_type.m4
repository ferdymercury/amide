...
m4_dnl Copyright (c) 2001 Andy Loening
m4_dnl 
...
m4_dnl each of the internal data formats
m4_dnl
...
m4_dnl
m4_dnl
m4_dnl Figure out what internal data format where making  
m4_ifdef(`m4_SourceFile', `
	m4_define(m4_File_Base_Name, `m4_substr(m4_SourceFile, 
		0, 
		m4_regexp(m4_SourceFile,`_[A-Z]'))')
	m4_define(m4_Temp_Internal_Data_Format, `m4_substr(m4_SourceFile, 
...
m4_m4exit')
m4_dnl
m4_dnl extract any additional information out of "Temp_Internal_Data_Format"

m4_ifelse(m4_regexp(m4_Temp_Internal_Data_Format, `_'), `-1',`
	m4_define(m4_Internal_Data_Format, m4_Temp_Internal_Data_Format)
	',`
	m4_define(m4_Scale_Dim, `m4_substr(m4_Temp_Internal_Data_Format,
		m4_eval(m4_regexp(m4_Temp_Internal_Data_Format, `_')+1))')
	m4_define(m4_Internal_Data_Format, `m4_substr(m4_Temp_Internal_Data_Format,
		0,
		m4_regexp(m4_Temp_Internal_Data_Format, `_'))')
')
m4_dnl
m4_dnl
/* m4_SourceFile 
