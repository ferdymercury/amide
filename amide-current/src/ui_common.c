...
#define AXIS_HEIGHT 140
#define AXIS_TEXT_MARGIN 10
#define AXIS_TOTAL_WIDTH 3*AXIS_WIDTH
...
GtkWidget * ui_common_create_view_axis_indicator(void) {
  ...
  gtk_widget_set_usize(GTK_WIDGET(axis_indicator), AXIS_TOTAL_WIDTH, AXIS_HEIGHT);
  gnome_canvas_set_scroll_region(axis_indicator, 0.0, 0.0, AXIS_TOTAL_WIDTH, AXIS_HEIGHT);
  ...
  for (i_view=0;i_view<NUM_VIEWS;i_view++) {
    gnome_canvas_item_new(gnome_canvas_root(axis_indicator),
			  ...
			  "text", view_names[i_view],
			  "x", (gdouble) (i_view+0.5)*AXIS_WIDTH,
			  "y", (gdouble) 0,
			  "font", "fixed", NULL);
  }
  ...
  axis_line_points->coords[0] = AXIS_MARGIN + TRANSVERSE*AXIS_WIDTH; /* x1 */
  axis_line_points->coords[1] = AXIS_HEIGHT-AXIS_MARGIN; /* y1 */
  axis_line_points->coords[2] = AXIS_WIDTH-AXIS_MARGIN + TRANSVERSE*AXIS_WIDTH; /* x2 */
  axis_line_points->coords[3] = AXIS_HEIGHT-AXIS_MARGIN; /* y2 */
  ...
  gnome_canvas_item_new(gnome_canvas_root(axis_indicator),
			...
			"text", "x",
			"x", (gdouble) AXIS_WIDTH-AXIS_MARGIN-AXIS_TEXT_MARGIN+TRANSVERSE*AXIS_WIDTH,
			"y", (gdouble) AXIS_HEIGHT-AXIS_MARGIN-AXIS_TEXT_MARGIN,
			"font", "fixed", NULL);
  ...
  axis_line_points->coords[0] = AXIS_MARGIN + TRANSVERSE*AXIS_WIDTH; /* x1 */
  axis_line_points->coords[1] = AXIS_HEIGHT-AXIS_MARGIN; /* y1 */
  axis_line_points->coords[2] = AXIS_MARGIN + TRANSVERSE*AXIS_WIDTH; /* x2 */
  axis_line_points->coords[3] = AXIS_HEADER; /* y2 */
  gnome_canvas_item_new(gnome_canvas_root(axis_indicator), gnome_canvas_line_get_type(),
			"points", axis_line_points, "fill_color", "black",
			"width_pixels", 3, "last_arrowhead", TRUE, 
			"arrow_shape_a", (gdouble) AXIS_ARROW_LENGTH,
  ...
  gnome_canvas_item_new(gnome_canvas_root(axis_indicator),
			...
			"text", "y",
			"x", (gdouble) AXIS_MARGIN+AXIS_TEXT_MARGIN+TRANSVERSE*AXIS_WIDTH,
			"y", (gdouble) AXIS_HEADER+AXIS_TEXT_MARGIN,
			"font", "fixed", NULL);
  ...
  /* the x axis */
  axis_line_points = gnome_canvas_points_new(2);
  axis_line_points->coords[0] = AXIS_MARGIN + CORONAL*AXIS_WIDTH; /* x1 */
  axis_line_points->coords[1] = AXIS_HEADER; /* y1 */
  axis_line_points->coords[2] = AXIS_WIDTH-AXIS_MARGIN + CORONAL*AXIS_WIDTH; /* x2 */
  axis_line_points->coords[3] = AXIS_HEADER; /* y2 */
  gnome_canvas_item_new(gnome_canvas_root(axis_indicator), gnome_canvas_line_get_type(),
			"points", axis_line_points, "fill_color", "black",
			"width_pixels", 3, "last_arrowhead", TRUE, 
  ...
  gnome_canvas_item_new(gnome_canvas_root(axis_indicator),
			...
			"text", "x",
			"x", (gdouble) AXIS_WIDTH-AXIS_MARGIN-AXIS_TEXT_MARGIN+CORONAL*AXIS_WIDTH,
			"y", (gdouble) AXIS_HEADER+AXIS_TEXT_MARGIN,
			"font", "fixed", NULL);

  /* the z axis */
  axis_line_points = gnome_canvas_points_new(2);
  axis_line_points->coords[0] = AXIS_MARGIN + CORONAL*AXIS_WIDTH; /* x2 */
  axis_line_points->coords[1] = AXIS_HEADER; /* y2 */
  axis_line_points->coords[2] = AXIS_MARGIN + CORONAL*AXIS_WIDTH; /* x1 */
  axis_line_points->coords[3] = AXIS_HEIGHT-AXIS_MARGIN; /* y1 */
  gnome_canvas_item_new(gnome_canvas_root(axis_indicator), gnome_canvas_line_get_type(),
			"points", axis_line_points, "fill_color", "black",
			"width_pixels", 3, "last_arrowhead", TRUE, 
			"arrow_shape_a", (gdouble) AXIS_ARROW_LENGTH,
  ...
  gnome_canvas_item_new(gnome_canvas_root(axis_indicator),
			...
			"anchor", GTK_ANCHOR_NORTH_WEST,
			"text", "z",
			"x", (gdouble) AXIS_MARGIN+AXIS_TEXT_MARGIN+CORONAL*AXIS_WIDTH,
			"y", (gdouble) AXIS_HEIGHT-AXIS_MARGIN-AXIS_TEXT_MARGIN,
			"font", "fixed", NULL);
  ...
  /* the y axis */
  axis_line_points = gnome_canvas_points_new(2);
  axis_line_points->coords[0] = AXIS_MARGIN + SAGITTAL*AXIS_WIDTH; /* x1 */
  axis_line_points->coords[1] = AXIS_HEADER; /* y1 */
  axis_line_points->coords[2] = AXIS_WIDTH-AXIS_MARGIN + SAGITTAL*AXIS_WIDTH; /* x2 */
  axis_line_points->coords[3] = AXIS_HEADER; /* y2 */
  gnome_canvas_item_new(gnome_canvas_root(axis_indicator), gnome_canvas_line_get_type(),
			"points", axis_line_points, "fill_color", "black",
			"width_pixels", 3, "last_arrowhead", TRUE, 
  ...
  gnome_canvas_item_new(gnome_canvas_root(axis_indicator),
			...
			"anchor", GTK_ANCHOR_NORTH_EAST,
			"text", "y",
			"x", (gdouble) AXIS_WIDTH-AXIS_MARGIN-AXIS_TEXT_MARGIN+SAGITTAL*AXIS_WIDTH,
			"y", (gdouble) AXIS_HEADER+AXIS_TEXT_MARGIN,
			"font", "fixed", NULL);

  /* the z axis */
  axis_line_points = gnome_canvas_points_new(2);
  axis_line_points->coords[0] = AXIS_MARGIN + SAGITTAL*AXIS_WIDTH; /* x2 */
  axis_line_points->coords[1] = AXIS_HEADER; /* y2 */
  axis_line_points->coords[2] = AXIS_MARGIN + SAGITTAL*AXIS_WIDTH; /* x1 */
  axis_line_points->coords[3] = AXIS_HEIGHT-AXIS_MARGIN; /* y1 */
  gnome_canvas_item_new(gnome_canvas_root(axis_indicator), gnome_canvas_line_get_type(),
			"points", axis_line_points, "fill_color", "black",
			"width_pixels", 3, "last_arrowhead", TRUE, 
  ...
  gnome_canvas_item_new(gnome_canvas_root(axis_indicator),
			...
			"anchor", GTK_ANCHOR_NORTH_WEST,
			"text", "z",
			"x", (gdouble) AXIS_MARGIN+AXIS_TEXT_MARGIN+SAGITTAL*AXIS_WIDTH,
			"y", (gdouble) AXIS_HEIGHT-AXIS_MARGIN-AXIS_TEXT_MARGIN,
			"font", "fixed", NULL);
