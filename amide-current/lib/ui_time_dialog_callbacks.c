...
void ui_time_dialog_callbacks_unselect_row(GtkCList * clist, gint row, gint column, GdkEventButton *event, gpointer data) {
...
void ui_time_dialog_callbacks_apply(GtkWidget* widget, gint page_number, gpointer data) {
...
void ui_time_dialog_callbacks_close_event(GtkWidget* widget, gpointer data) {
