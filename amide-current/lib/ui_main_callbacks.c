...
void ui_main_callbacks_open_study(GtkWidget * button, gpointer data) {
...
void ui_main_callbacks_new_study(GtkWidget * button, gpointer data) {
...
void ui_main_callbacks_about(GtkWidget * button, gpointer data) {
...
void ui_main_callbacks_delete_event(GtkWidget * app, gpointer data) {
